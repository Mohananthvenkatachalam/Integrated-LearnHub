...
function OrbitingCirclesDemo() {
  return (
    <div className='relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
      ...
      {/* Inner Circles */}
      <OrbitingCircles className='size-[50px] bg-white p-2' duration={20} delay={20} radius={100}>
        <Icons.whatsapp />
      </OrbitingCircles>
      <OrbitingCircles className='size-[50px] bg-white p-2' duration={20} delay={10} radius={100}>
        <Icons.notion />
      </OrbitingCircles>

      {/* Outer Circles (reverse) */}
      <OrbitingCircles className='size-[70px] bg-white p-3' radius={190} duration={20} reverse>
        <Icons.googleDrive />
      </OrbitingCircles>
      <OrbitingCircles
        className='size-[70px] bg-white p-3'
        radius={190}
        duration={20}
        delay={20}
        reverse
...
const Integrations = () => {
  return (
    <section className='bg-white py-10 sm:py-16 lg:py-24' id='integrations'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 items-center gap-y-12 lg:grid-cols-2 lg:gap-x-24'>
          <div>
            <OrbitingCirclesDemo />
            {/* <img src='https://cdn.rareblocks.xyz/collection/celebration/images/integration/2/services-icons.png' /> */}
          </div>

          <div className='text-center lg:text-left'>
            <h2 className='text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl'>
              Grow your Knowledge with our Community.
            </h2>
