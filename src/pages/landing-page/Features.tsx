      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-10 grid grid-cols-1 gap-y-12 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 md:grid-cols-3 md:gap-0 xl:mt-24'>
          <div className='md:p-8 lg:p-14'>
            ...
            <h3 className='font-pj mt-12 text-xl font-bold text-gray-900'>Support</h3>
          ...
          <div className='md:border-l md:border-gray-200 md:p-8 lg:p-14'>
            ...
            <h3 className='font-pj mt-12 text-xl font-bold text-gray-900'>Learning</h3>
            <p className='font-pj mt-5 text-base text-gray-600'>
              Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh
              et sagittis a. Lacinia purus ac amet.
            </p>
          ...
          <div className='md:border-l md:border-gray-200 md:p-8 lg:p-14'>
            ...
            <h3 className='font-pj mt-12 text-xl font-bold text-gray-900'>Contest</h3>
            <p className='font-pj mt-5 text-base text-gray-600'>
              Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh
              et sagittis a. Lacinia purus ac amet.
            </p>
          ...
          <div className='md:border-t md:border-gray-200 md:p-8 lg:p-14'>
            ...
            <h3 className='font-pj mt-12 text-xl font-bold text-gray-900'>Achievements</h3>
            <p className='font-pj mt-5 text-base text-gray-600'>
              Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh
              et sagittis a. Lacinia purus ac amet.
            </p>
          ...
          <div className='md:border-l md:border-t md:border-gray-200 md:p-8 lg:p-14'>
            ...
            <h3 className='font-pj mt-12 text-xl font-bold text-gray-900'>Quality</h3>
            <p className='font-pj mt-5 text-base text-gray-600'>
              Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh
              et sagittis a. Lacinia purus ac amet.
            </p>
          ...
          <div className='md:border-l md:border-t md:border-gray-200 md:p-8 lg:p-14'>
            ...
            <h3 className='font-pj mt-12 text-xl font-bold text-gray-900'>Result</h3>
            <p className='font-pj mt-5 text-base text-gray-600'>
              Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh
              et sagittis a. Lacinia purus ac amet.
            </p>
